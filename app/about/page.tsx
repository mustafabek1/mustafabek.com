...
export const metadata: Metadata = {
  title: "About | Mustafa Bek",
  metadataBase: new URL("https://mustafabek.com/about"),
  description:
    "Learn more about my skills, experience and technical background",
  openGraph: {
    title: "About | Mustafa Bek",
    url: "https://mustafabek.com/about",
    description:
      "Learn more about my skills, experience and technical background",
    images:
      "",
        ...
        <div className="order-2 lg:order-none">
          <Slide>
            ...
            <div className="dark:text-zinc-400 text-zinc-600 leading-relaxed">
              <PortableText value={profile.fullBio} components={CustomPortableText} />
            </div>
          </Slide>
        </div>
            ...
            <div className="sticky top-10">
              ...
              <div className="flex flex-col text-center gap-y-4">
                <div className="flex items-center gap-x-3">
                  <RefLink
                    href="https://drive.google.com/file/d/1wcrbWCvCZ1STC217jNHjwc8hus0UXUWS/view?usp=sharing"

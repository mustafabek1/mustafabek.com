...
export const metadata: Metadata = {
  title: "Blog | Mustafa Bek",
  metadataBase: new URL("https://mustafabek.com/blog"),
  description: "Read latest stories from Mustafa Bek's Blog",
  openGraph: {
    title: "Blog | Mustafa Bek",
    url: "https://mustafabek.com/blog",
    description: "Read latest stories from Mustafa Bek's Blog",
    images:
